...
SPQR_tree[0] = ("S", [0,1,2], [(1,(1,2)), (2,(0,1))], [(0,1),(1,2),(0,2)])
...
SPQR_tree[1] = ("S", [1,8,9,2], [(0,(1,2))], [(1,2),(1,8),(8,9),(2,9)])
...
SPQR_tree[2] = ("R", [0,1,4,3], [(0,(0,1))], [(0,1),(1,4),(0,4),(0,3),(1,3),(3,4)])
...
# SPQR_tree[0] = ("S", [0,1,2], [(1,(1,2))], [(0,1),(1,2),(0,2)])
...
# SPQR_tree[1] = ("R", [1,2,3,4], [(0,(1,2)), # (2,(1,3)) # , (3,(2,3))
...
# SPQR_tree[2] = ("S", [1,3,5,6,7], [(1,(1,3))], [(1,3),(1,5),(5,6),(6,7),(3,7)])
...
# SPQR_tree[3] = ("P", [2, 3], [(1, (2,3))], [(2,3),(2,3)])
...
def draw_skeleton(j, c, angle, radius, parent = (-1, -1)):
    ...
    if tree_type == "P":
        ...
        print ("EE", e)
        print ("VE", ve)
        y1, x1 = 25, 50 # drawn_ve[e[0]][0]
        y2, x2 = 30, 50 # drawn_ve[e[0]][1]
        drawn_ve[e[1]] = ((x1, y1), (x2, y2), math.atan2(y1 - y2, x1 - x2))
        drawn_ve[e[2]] = ((x1, y1), (x2, y2), math.atan2(y1 - y2, x1 - x2))
        drawn_ve[e[3]] = ((x1, y1), (x2, y2), math.atan2(y1 - y2, x1 - x2))
        drawn_ve[e[4]] = ((x1, y1), (x2, y2), math.atan2(y1 - y2, x1 - x2))
        drawn_ve[e[5]] = ((x1, y1), (x2, y2), math.atan2(y1 - y2, x1 - x2))
        print (drawn_ve)
